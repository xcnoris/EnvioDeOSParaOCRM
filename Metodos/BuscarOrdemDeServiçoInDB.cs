    ...
    internal class BuscarOrdemDeServicoInDB
    {
        ...
        internal DataTable BuscarOrdemDeServiçoInDB()
        {
            try
            {
                ...
                string query = "SELECT id_ordem_servico, nome_cliente, fone_ddd_cliente + fone_numero_cliente AS telefone, email_cliente, id_categoria_ordem_servico FROM ordem_servico WHERE data_hora_cadastro >= '01/07/2024' AND id_ordem_servico = 7641";
